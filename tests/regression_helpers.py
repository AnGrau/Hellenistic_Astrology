...
def assert_observation_matches(observation: Observation, fixture: dict) -> None:
    ...
    assert_point_matches(observation.part_of_eros, fixture["part_of_eros"], "Part d'Éros")
    assert_point_matches(observation.north_node, fixture["north_node"], "Nœud Nord")
    assert_point_matches(observation.south_node, fixture["south_node"], "Nœud Sud")
